...
public class ColumnMessageActivity extends AppCompatActivity implements View.OnClickListener {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        columnMessageFragment = new ColumnMessageFragment();
        ...
        viewPager = (ViewPager) findViewById(R.id.column_view_pager);
